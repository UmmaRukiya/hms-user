								...
								<div className="single-main">
									...
									<div className="meta">
										<div className="meta-left">
											<span className="author"><a href="#"><img src="assets1/img/author1.jpg" alt="#"/>Naimur Rahman</a></span>
					...
					<div className="col-lg-4 col-12">
						<div className="main-sidebar">
							...
							<div className="single-widget recent-post">
								...
								<div className="single-post">
									<div className="image">
										<img src="assets1/img/blog-sidebar2.jpg" alt="#"/>
									</div>
									<div className="content">
								...
								<div className="single-post">
									<div className="image">
										<img src="assets1/img/blog-sidebar3.jpg" alt="#"/>
									</div>
									<div className="content">
